...
results = open("diabetesBestResults.txt" , "w")
...
for index in range(len(data)):
    data[index] = (data[index] - np.mean(data))/np.std(data);
...
mlp = MLPRegressor(hidden_layer_sizes=(100,100), max_iter=2000, random_state=13);
...
#Write Params down
results = open("diabetesBestResults.txt" , "a")
